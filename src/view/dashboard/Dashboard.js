      ...
      <Row className="w-100 nav p-15 h-25 " align={"middle"} justify={"center"}>
        ...
        <Col lg={10} >
          ...
          <Radio.Group onChange={(e) => setKey(e.target.value)} value={key} >
            <Row justify={"center"}>
              <Col><Radio.Button value="respon">ผู้ตอบแบบสอบถาม</Radio.Button> </Col >
              <Col><Radio.Button value="economic">มูลค่าทางเศรษฐกิจ</Radio.Button></Col>
              <Col><Radio.Button value="satis">ระดับความพึงพอใจ</Radio.Button></Col>
            </Row>
          </Radio.Group>
