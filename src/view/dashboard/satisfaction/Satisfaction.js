            ...
            <Row justify={"center"} gutter={[15, 15]}>
                <Col lg={24} md={24} sm={24} xs={24}>
                    <Card>
                       ...
                       <h4 className="pt-5  ">การสำรวจความพึงพอใจของผู้เข้ารวมงาน มีความพึงพอใจในการจัดงานโดยรวมอยู่ในระดับมาก (ค่าเฉลี่ย 4.13) 
                        ...
                        และด้านสถานที่การจัดการแข่งขันและที่พัก  (ค่าเฉลี่ย4.12)  ตามลำดับ</h4>
                    </Card>
